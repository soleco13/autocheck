...
const PROMPT_META: Record<string, { label: string; desc: string; model: string }> = {
  ...
  checker_vision_system: {
    label: 'Системный промпт проверки фото',
    desc: 'Инструкции для мультимодальной модели при проверке рукописных решений, прикреплённых фото. Её вердикт передаётся в итоговый отчёт.',
